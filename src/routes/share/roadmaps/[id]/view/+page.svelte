...
<svelte:head>
    <title>{title.replace('Learning Roadmap', '')} Shared Roadmap | Gribbin</title>
</svelte:head>
    ...
    {:else if roadmap && parsedContent}
        ...
        <div class="flex items-start justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">A learning roadmap generated on <a href="/" class="text-indigo-500 hover:cursor-pointer">Gribbin</a></p>
            </div>
            <div class="flex gap-4">
                ...
                >
                    ...
                    {:else}
                        {@html $user ? 'Save to My Roadmaps' : 'Made with &hearts; by Ammar'}
                    {/if}
                </button>
                <a
        ...
        {#if !$user}
            <div class="rounded-lg bg-indigo-50 p-6">
                <h3 class="text-lg font-semibold text-indigo-900">Get More with Gribbin</h3>
